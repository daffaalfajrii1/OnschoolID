        ...
        <div class="main-wrapper main-wrapper-02">
            ...
            <div class="section overflow-hidden position-relative" id="wrapper">
                ...
                <div class="sidebar-wrapper">
                    <div class="menu-list">
                        <a class="{{ Request::segment(2) == '' || Request::segment(2) == 'dashbord' ? 'active' : '' }}" href="{{route('member.dashboard')}}"><i class="icofont-dashboard" style="color: white; font-size: 30px;" title="Dashboard"></i></a>
                        <a class="{{ Request::segment(2) == 'kelas-saya' ? 'active' : '' }}" href="{{route('member.kelas')}}"><i class="icofont-listing-box" style="color: white; font-size: 25px;" title="Kelas Saya"></i></a>
                        <a href="{{route('member.billing')}}"><i class="icofont-money" style="color: white; font-size: 25px;" title="Billing"></i></a>
                    ...
                    <div class="container">
                        ...
                        <div class="copyright-wrapper">
                            ...
                            <div class="copyright-text">
                                <p>&copy; {{date('Y')}} <span> {{$pengaturan->nama_web}} </span> Powered by <img src="{{asset('assets/images/powered.png')}}" style="width: 90px" /> Support <i class="icofont-heart-alt"></i> by  <a> UNIB </a></p>
                            </div>
                        </div>
