                ...
                <div class="x_panel">
                    <div class="x_title">
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                            	<a href="{{route('admin.kelas.permintaan.terima', $kelas->id)}}" class="btn btn-sm btn-success btn-block">Terima</a>
                            </div>
                            <div class="col-sm-1">
								<a href="#tolak" class="btn btn-sm btn-danger btn-block tolak">Tolak</a>
                            </div>
                        </div>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header bg-dark">
				<h5 class="modal-title text-white" id="appDetaillabel">Tolak Kelas</h5>
			...
			<div class="modal-body p-5">
				<form method="post" action="{{route('admin.kelas.permintaan.tolak', $kelas->id)}}" enctype="multipart/form-data">
					@csrf	
					<div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3">Alasan Ditolak</label>
                        <div class="col-md-9 col-sm-9">
                            <textarea class="form-control" name="alasan" required="" placeholder="Alasan Ditolak"></textarea>
                        </div>
                    </div>
