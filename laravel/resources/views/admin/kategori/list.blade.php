            ...
            <div class="title_right">
                <div class="col-md-3 col-sm-5 form-group pull-right top_search">
                    <div class="input-group">
                        <a href="{{route('admin.kategori.tambah')}}" class="btn btn-sm btn-success btn-block mb-0">Tambah Kategori</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <tbody>
									...
									<tr class="<?= $no % 2 == 0 ? 'even pointer' : 'odd pointer'?>">
										...
										<td>
											<a href="{{route('admin.kategori.edit', $item->id)}}" class="btn btn-sm btn-info">Edit</a>
											<a href="{{route('admin.kategori.hapus', $item->id)}}" class="btn btn-sm btn-danger">Hapus</a>
										</td>
									</tr>
									@php $no++; @endphp
									@endforeach
                            ...
                            {!!@$kategori->appends(['cari'=>@$_GET['cari'],'sort'=>@$_GET['sort']])->links('admin.pagination')!!}
                        </div>
                    </div>
                </div>
            </div>
