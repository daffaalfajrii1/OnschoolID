...
<div class="page-content-wrapper" style="min-height: 100vh !important; overflow: auto !important;">
    <div class="container-fluid custom-container">
        <div class="form-wrapper">
            ...
            @endif
            <form action="{{route('mentor.tambah_kelas.simpan')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="single-form">
                            ...
                            <input type="text" name="kelas" required placeholder="Masukkan Nama Kelas" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="single-form">
                    ...
                    <div class="col-md-12">
                        <div class="single-form">
                            ...
                            <textarea type="text" placeholder="Deskripsi Singkat" name="deskripsi_singkat" required>{{old('deskripsi_singkat')}}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="single-form">
                            ...
                            <input type="number" name="biaya" required placeholder="Masukkan Biaya Kelas" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="single-form">
                    ...
                    <div class="col-md-12">
                        <div class="single-form">
                            ...
                            <textarea type="text" placeholder="Deskripsi Singkat" id="deskripsi" name="deskripsi" required>{{old('deskripsi')}}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="single-form">
                            ...
                            <small style="font-size: 10px;"><b>Note:</b> Hanya untuk JPG, JPEG dan PNG. kami menyarankan ukuran 600px * 450px.</small>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="single-form">
                            <label>Upload Video</label>
                            <input type="text" name="video_url" required placeholder="Masukkan URL Video" />
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="row after-add-more-faq">
                    ...
                    <div class="col-md-6">
                        <div class="single-form">
                            <label>Jawaban</label>
                            <input type="text" name="faq_jawaban[]" required placeholder="Silahkan isi jawaban" />
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="single-form">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="single-form">
                            ...
                            <textarea name="pesan" placeholder="Silahkan isi pesan anda untuk Administrator sebagai bahan pertimbangan tambahan"></textarea>
                        </div>
                    </div>
                </div>
                <div class="single-form">
