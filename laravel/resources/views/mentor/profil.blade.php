...
<div class="page-content-wrapper" style="min-height: 100vh !important; overflow: auto !important;">
    <div class="container-fluid custom-container">
        <div class="form-wrapper">
            @if(Session::get('status_nya'))
            <div class="alert alert-success" role="alert">{{Session::get('status_nya')}}</div>
            @endif
            <form action="{{route('mentor.profil.simpan')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="single-form">
                            ...
                            <input type="text" name="pendidikan" value="{{Session::get('pendidikan')}}" placeholder="Pekerjaan" required=""/>
                    ...
                    <div class="col-md-12">
                        <div class="single-form">
                            ...
                            <textarea name="deskripsi" placeholder="Deskripsi">{{Session::get('deskripsi')}}</textarea>
